export default {
  email: {
    reviewPending: {
      ...
      text: {
        ...
        information:
          ...
          "Tant qu'elle n'est pas vérifiée, elle ne peut ni publier de camps ni envoyer de newsletters.",
    ...
    verified: {
      ...
      preview: '{{ organization.name }} peut désormais publier des camps',
      text: {
        title: 'Ton organisation a été vérifiée',
        information:
          '{{ organization.name }} a été vérifiée. ' +
          'Tu peux maintenant publier ses camps et envoyer des newsletters.',
