  ...
  email: {
    retentionDue: {
      ...
      text: {
        ...
        information:
          'Les informations sur la protection des données publiées pour {{ camp.name }} indiquent aux personnes inscrites que leurs données sont conservées {{ months }} mois $t(camp:email.retentionDue.anchor.{{anchor}}). Pour cet événement, cette durée prend fin le {{ dueAt }}.',
        action:
