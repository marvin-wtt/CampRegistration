  ...
  email: {
    retentionDue: {
      ...
      text: {
        ...
        information:
          'In den Datenschutzinformationen zu {{ camp.name }} steht, dass die Daten {{ months }} Monate $t(camp:email.retentionDue.anchor.{{anchor}}) gespeichert werden. Für diese Veranstaltung endet diese Frist am {{ dueAt }}.',
        action:
