  ...
  email: {
    retentionDue: {
      ...
      text: {
        ...
        information:
          'Informacje o ochronie danych opublikowane dla obozu {{ camp.name }} mówią zgłaszającym się, że ich dane są przechowywane przez {{ months }} miesięcy $t(camp:email.retentionDue.anchor.{{anchor}}). Dla tego obozu okres ten kończy się {{ dueAt }}.',
        action:
          'Przejrzyj proszę zgłoszenia obozu i usuń to, co nie jest już potrzebne. Tylko wy możecie ocenić, co należy zachować dłużej.',
        exceptions:
        ...
        noAutomaticDeletion:
          'Nic nie zostało usunięte automatycznie. Ta platforma nigdy sama nie kasuje danych obozu — decyzja i działanie należą do was.',
        button: 'Otwórz obóz',
