...
import type { RegistrationManagerNotificationProps } from './types';

defineProps<RegistrationManagerNotificationProps>();
</script>
    ...
    >
      ...
      >
        <mj-column>
          ...
          <email-paragraph>{{ information }}</email-paragraph>
          <email-button
            :primary-color="primaryColor"
            :href="url"
          >
