            ...
            elements: [
              {
                ...
                name: 'consent_rules',
                title: {
                  en: 'I have read the [camp rules](http://localhost:3000/) and agree to them.',
                  de: 'Ich habe die [Campregeln](http://localhost:3000/) gelesen und bin damit einverstanden.',
                  fr: "J'ai lu et j'accepte le [règlement](http://localhost:3000/) de la colonie de vacances.",
                  pl: 'Przeczytałem/łam [regulamin obozu](http://localhost:3000/) i akceptuję go.',
                  cs: 'Přečetl/a jsem si [táborová pravidla](http://localhost:3000/) a souhlasím s nimi.',
                  default:
                    'I have read the [camp rules](http://localhost:3000/) and agree to them.',
                },
                correctAnswer: true,
                isRequired: true,
                requiredErrorText: {
              ...
              },
              {
                ...
                title: {
                  en: 'I have read the [General Terms and Conditions](http://localhost:3000/) and agree to them.',
                  de: 'Ich habe die [allgemeinen Geschäftsbedingungen](http://localhost:3000/) gelesen und stimme diesen zu.',
                  fr: "J'ai lu et j'accepte les [conditions générales](http://localhost:3000/).",
                  pl: 'Przeczytałem/łam [regulamin / warunki uczestnictwa](http://localhost:3000/) i je akceptuję.',
                  cs: 'Přečetl/a jsem si [obchodní podmínky](http://localhost:3000/) a souhlasím s nimi.',
                  default:
                    'I have read the [General Terms and Conditions](http://localhost:3000/) and agree to them.',
                },
                correctAnswer: true,
                isRequired: true,
                requiredErrorText: {
