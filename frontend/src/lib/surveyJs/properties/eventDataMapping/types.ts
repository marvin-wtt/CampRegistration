...
export const address: EventDataType = {
  element: {
    value: 'address',
    text: {
      en: 'Address',
...
export const country: EventDataType = {
  element: {
    value: 'country',
    text: {
      en: 'Country',
...
export const dateOfBirth: EventDataType = {
  element: {
    value: 'date_of_birth',
    text: {
      en: 'Date of Birth',
...
export const email: EventDataType = {
  element: {
    value: 'email',
    text: {
      en: 'E-Mail (Contact)',
...
export const firstName: EventDataType = {
  element: {
    value: 'first_name',
    text: {
      en: 'First Name',
...
export const gender: EventDataType = {
  element: {
    value: 'gender',
    text: {
      en: 'Gender',
...
export const lastName: EventDataType = {
  element: {
    value: 'last_name',
    text: {
      en: 'Last Name',
...
export const name: EventDataType = {
  element: {
    value: 'name',
    text: {
      en: 'Name',
...
export const role: EventDataType = {
  element: {
    value: 'role',
    text: {
      en: 'Role',
...
export const waitingList: EventDataType = {
  element: {
    value: 'waiting_list',
    text: {
      en: 'Waiting List',
...
export const newsletterConsent: EventDataType = {
  element: {
