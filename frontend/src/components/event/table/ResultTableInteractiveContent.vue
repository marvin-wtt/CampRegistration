...
import TableTemplateIndexDialog from '@/components/event/table/dialogs/TableTemplateIndexDialog.vue';
...
// Only mounted by `ResultTableInteractive` once everything has loaded: the
// table model resolves its initial state (selected template, sort) from these
// props at setup, so they must be complete by then.
