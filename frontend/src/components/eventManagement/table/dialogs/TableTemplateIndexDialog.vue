    ...
    <q-card class="q-dialog-plugin q-pb-none">
      ...
      <q-card-section class="q-pt-none">
        <sortable-list
          ...
          :addable="can('event.table_templates.create')"
          :editable="can('event.table_templates.edit')"
          :sortable="can('event.table_templates.edit')"
          :deletable="can('event.table_templates.delete')"
          bordered
          separator
          @add="addTemplate"
...
import type { Event, TableTemplate } from '@camp-registration/common/entities';
import TableTemplateEditDialog from '@/components/eventManagement/table/dialogs/TableTemplateEditDialog.vue';
import SortableList from '@/components/common/SortableList.vue';
import { ref, toRaw } from 'vue';
import { usePermissions } from '@/composables/permissions';
import { deepToRaw } from '@/utils/deepToRaw';

const { event, templates } = defineProps<{
