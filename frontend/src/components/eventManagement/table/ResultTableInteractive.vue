...
import TableTemplateIndexDialog from '@/components/eventManagement/table/dialogs/TableTemplateIndexDialog.vue';
import TableCellWrapper from '@/components/eventManagement/table/TableCellWrapper.vue';
...
import PrintTableDialog from '@/components/eventManagement/table/dialogs/PrintTableDialog.vue';
import RegistrationActionList from '@/components/eventManagement/table/RegistrationActionList.vue';
import RegistrationRowCardDialog from '@/components/eventManagement/table/dialogs/RegistrationRowCardDialog.vue';
import { computed, nextTick, ref, toRef } from 'vue';
import { MBtn } from '@anoyomoose/q2-fresh-paint-md3e/components/Md3eBtn';

const { questions, registrations, templates, event } = defineProps<{
...
const canEditTemplates = computed<boolean>(() => {
  return (
    can('event.table_templates.create') ||
    can('event.table_templates.edit') ||
    can('event.table_templates.delete')
  );
});
...
template: 'Template'
title: 'Participants'
subtitle: 'Browse, filter, and print the registrations of this event.'
