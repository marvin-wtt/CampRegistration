...
import FileSelectionDialog from '@/components/eventManagement/settings/files/FileSelectionDialog.vue';
import type {
  EventDetails,
  ServiceFile,
...
import { surveyCreatorCustomLocaleConfig } from '@/components/eventManagement/settings/form/form-editor-translations';
