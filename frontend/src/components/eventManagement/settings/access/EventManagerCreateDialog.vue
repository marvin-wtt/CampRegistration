...
import { ref } from 'vue';
import ManagerExpirationInput from '@/components/eventManagement/settings/access/ManagerExpirationInput.vue';
import type {
...
defineProps<{
  ...
  roles: QSelectOption<EventManagerRole>[];
}>();
defineEmits([...useDialogPluginComponent.emits]);

const email = ref<string>('');
const expiresAt = ref<string | null | undefined>(undefined);
const role = ref<EventManagerRole>('COUNSELOR');

function onInvite() {
  const data: EventManagerCreateData = {
    email: email.value,
