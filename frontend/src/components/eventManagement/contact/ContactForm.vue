...
import ContactSelect from '@/components/eventManagement/contact/ContactSelect.vue';
import type { Message, Registration } from '@camp-registration/common/entities';
import type {
  Contact,
  ContactDraft,
} from '@/components/eventManagement/contact/Contact';
import { QForm, type QSelectOption, useQuasar } from 'quasar';
import { type QRejectedEntry } from 'quasar';
import { useEventDetailsStore } from '@/stores/event-details-store';
import RegistrationEmailEditor from '@/components/eventManagement/contact/RegistrationEmailEditor.vue';
