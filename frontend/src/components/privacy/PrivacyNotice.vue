...
dataProvision: 'Fields marked as required have to be filled in before the registration can be submitted; without them we cannot process it. Everything else is optional — you can leave it blank, and it will not affect your registration.'
...
rights:
  ...
  withdrawConsent: 'Withdrawal of any consent you gave, at any time and as easily as you gave it (Art. 7(3) GDPR)'
...
dataProvision: 'Als Pflichtfeld gekennzeichnete Angaben müssen ausgefüllt werden, bevor die Anmeldung abgeschickt werden kann; ohne sie können wir sie nicht bearbeiten. Alles andere ist freiwillig – du kannst es leer lassen, ohne dass das Auswirkungen auf deine Anmeldung hat.'
...
rights:
  ...
  withdrawConsent: 'Widerruf einer erteilten Einwilligung, jederzeit und so einfach wie die Erteilung (Art. 7 Abs. 3 DSGVO)'
...
dataProvision: "Les champs signalés comme obligatoires doivent être remplis pour que l'inscription puisse être envoyée ; sans eux, nous ne pouvons pas la traiter. Tout le reste est facultatif — vous pouvez le laisser vide, cela n'aura aucune incidence sur votre inscription."
...
rights:
  ...
  withdrawConsent: "Retrait de tout consentement donné, à tout moment et aussi simplement que vous l'avez donné (art. 7, § 3, RGPD)"
...
dataProvision: 'Pole označená jako povinná je nutné vyplnit, aby šlo přihlášku odeslat; bez nich ji nemůžeme zpracovat. Vše ostatní je dobrovolné – můžeš to nechat prázdné, na tvoji přihlášku to nemá vliv.'
...
rights:
  ...
  withdrawConsent: 'Odvolání uděleného souhlasu, kdykoli a stejně snadno, jako byl udělen (čl. 7 odst. 3 GDPR)'
...
dataProvision: 'Pola oznaczone jako obowiązkowe trzeba wypełnić, aby wysłać zgłoszenie; bez nich nie możemy go rozpatrzyć. Wszystko inne jest dobrowolne – możesz zostawić puste, nie wpłynie to na Twoje zgłoszenie.'
...
rights:
  ...
  withdrawConsent: 'Wycofanie udzielonej zgody w dowolnym momencie, równie łatwo jak jej udzielenie (art. 7 ust. 3 RODO)'
