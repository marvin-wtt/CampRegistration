...
import FormEditor from '@/components/eventManagement/settings/form/FormEditor.vue';
import type { SurveyJSEventData } from '@camp-registration/common/entities';
import type { ITheme } from 'survey-core';
import EditorRestrictedAccessDialog from '@/components/eventManagement/settings/form/EditorRestrictedAccessDialog.vue';
