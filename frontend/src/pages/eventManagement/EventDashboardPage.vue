...
import EventSummaryHero from '@/components/eventManagement/dashboard/EventSummaryHero.vue';
import StatCard from '@/components/eventManagement/dashboard/StatCard.vue';
import CountryBreakdownTable from '@/components/eventManagement/dashboard/CountryBreakdownTable.vue';
import DemographicsExplorer from '@/components/eventManagement/dashboard/DemographicsExplorer.vue';
import TasksDueWidget from '@/components/eventManagement/dashboard/TasksDueWidget.vue';
...
} from '@/components/eventManagement/table/localTableTemplates';
