...
import EventCardSkeleton from '@/components/listedEvents/EventCardSkeleton.vue';
import EventFilterBar from '@/components/listedEvents/EventFilterBar.vue';
import EventGrid from '@/components/listedEvents/EventGrid.vue';
