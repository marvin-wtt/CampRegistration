...
export default {
  ...
  retentionConsentSentence: 'Kept for as long as you consent to it, and erased once you withdraw that consent.',
  ...
  gap: {
    ...
    retention_exception_consent_basis: 'Data kept until consent is withdrawn is tied to a purpose that does not rest on consent',
