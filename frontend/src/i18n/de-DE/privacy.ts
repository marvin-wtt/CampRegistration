export default {
  ...
  retentionConsentSentence: 'Wird so lange gespeichert, wie du einwilligst, und nach deinem Widerruf gelöscht.',
  ...
  gap: {
    ...
    retention_exception_consent_basis: 'Daten, die bis zum Widerruf gespeichert werden, gehören zu einem Zweck, der nicht auf einer Einwilligung beruht',
    transfer_countries:
